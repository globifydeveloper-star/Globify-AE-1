              ...
              <Link key={study.slug} href={`/case-study/${study.slug}`} className="block group">
                ...
                >
                  <div className="aspect-[16/10] overflow-hidden">
                    <Image src={study.image} alt={study.title} width={640} height={400} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="p-5">
