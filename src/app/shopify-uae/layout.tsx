...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Shopify and Shopify Plus stores for UAE brands. Stripe, PayTabs, Network International, Tabby, Tamara, Aramex, Quiqup. VAT-compliant, Arabic RTL ready. 30+ Shopify stores delivered.",
  ...
  twitter: {
    ...
    description: "Shopify stores for UAE brands. Tabby, Tamara, PayTabs, Aramex, UAE VAT, Arabic RTL. 30+ Shopify stores delivered.",
  },
};
