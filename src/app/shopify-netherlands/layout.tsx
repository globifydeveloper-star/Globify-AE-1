...
export const metadata: Metadata = {
  ...
  description: "Shopify and Shopify Plus development for brands in the Netherlands. iDEAL and Klarna checkout, PostNL and DHL integration, GDPR-compliant, EU office in Germany. 30+ stores launched, ISO 27001 certified Shopify Partner.",
  keywords: [
  ...
  openGraph: {
   title: "Shopify Development Agency Netherlands | Shopify Partner",
    description: "Shopify and Shopify Plus stores for Dutch brands. iDEAL, Klarna, PostNL ready, GDPR-compliant. EU presence in Germany. 30+ stores launched.",
  ...
  twitter: {
    ...
    description: "Shopify and Shopify Plus stores for Dutch brands. iDEAL, PostNL, GDPR-ready. 30+ launched.",
  },
};
